...
## General Principles for PHP Code
...
## Key Differences from Typical PHP Projects

- IMPORTANT: PHP variables are snake_case, not camelCase or PascalCase.
- UTC timezone by default (both PHP and database)
- E.164 format for phone numbers when cast to string ("+13145551234" not "3145551234")
- No local configuration files - use environment variables
...
- Type-safe collections: `Collection<T>`, `Map<K, V>`
