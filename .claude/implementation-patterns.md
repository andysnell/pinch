...
1. Analyze requirements and determine the correct package (core/components/framework)
...
5. Write PHPUnit 12 tests with attributes and static data providers
6. Create OpenAPI schemas for domain objects, update README.md
7. Register services in appropriate service providers
