...
use PhoneBurner\Pinch\Time\Interval\CarbonImmutableRange;
...
final class CarbonImmutableRangeTest extends TestCase
{
    #[Test]
    public function constructorCreatesValidRangeFromDateTimeImmutable(): void
    {
        ...
        $range = new CarbonImmutableRange($start, $end);
    ...
    public function constructorAllowsEqualStartAndEnd(): void
    {
        ...
        $range = new CarbonImmutableRange($date, $date);
    ...
    public function constructorThrowsExceptionWhenEndIsBeforeStart(): void
    {
        ...
        new CarbonImmutableRange($start, $end);
    }
    ...
    public function constructorAcceptsCustomBoundary(): void
    {
        ...
        $range = new CarbonImmutableRange($start, $end, IntervalBoundary::OpenOpen);
    ...
    public function constructorAcceptsAllBoundaryTypes(IntervalBoundary $boundary): void
    {
        $start = new \DateTimeImmutable('2024-01-01');
        $end = new \DateTimeImmutable('2024-12-31');
        $range = new CarbonImmutableRange($start, $end, $boundary);
    ...
    {
        $range = new CarbonImmutableRange(
    ...
    {
        $start = new CarbonImmutable('2024-01-01');
        $end = new CarbonImmutable('2024-12-31');
        $range = new CarbonImmutableRange($start, $end);
    ...
    public function publicPropertiesAreAccessible(): void
    {
        $start = new CarbonImmutable('2024-01-01');
        $end = new CarbonImmutable('2024-12-31');
        $range = new CarbonImmutableRange($start, $end, IntervalBoundary::OpenClosed);
