...
final class ContentType
{
    ...
    private const array EXTENSION_MAP = [
        ...
        'bpk' => self::OCTET_STREAM,
        'deploy' => self::OCTET_STREAM,
        'dist' => self::OCTET_STREAM,
        'distz' => self::OCTET_STREAM,
        'dms' => self::OCTET_STREAM,
        'dump' => self::OCTET_STREAM,
        'elc' => self::OCTET_STREAM,
        'lha' => self::OCTET_STREAM,
        'lrf' => self::OCTET_STREAM,
